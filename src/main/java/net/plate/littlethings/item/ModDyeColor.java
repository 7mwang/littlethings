...
public enum ModDyeColor implements StringIdentifiable {
    CRIMSON(1, "crimson", 14423100, MapColor.DARK_CRIMSON, 14423100, 14423100);
    ...
    public static final EnumCodec<ModDyeColor> CODEC = StringIdentifiable.createCodec(ModDyeColor::values);
